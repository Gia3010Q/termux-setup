...
show_progress() {
    ...
    # Tạo thanh tiến trình với gradient
    for i in {1..30}; do
        if [ $i -le 10 ]; then
            color="${CYAN}"
        elif [ $i -le 20 ]; then
...
show_status "Tải tdm3.py" "⬇️" "${LIGHT_PURPLE}"
...
echo -e "${LIGHT_GREEN}[✓] Tải tdm3.py hoàn tất!${NC}"

show_status "Tải sn01.py" "⬇️" "${LIGHT_YELLOW}"
...
echo -e "${LIGHT_GREEN}[✓] Tải sn01.py hoàn tất!${NC}"

show_status "Tải ld5.py" "⬇️" "${LIGHT_CYAN}"
...
echo -e "${LIGHT_GREEN}[✓] Tải ld5.py hoàn tất!${NC}"
echo ""
...
echo -e "║ ${LIGHT_YELLOW}2. ${LIGHT_GREEN}python sn01.py ${LIGHT_CYAN}                                   ║"
echo -e "║ ${LIGHT_YELLOW}3. ${LIGHT_YELLOW}python tdm3.py ${LIGHT_CYAN}                                  ║"
echo -e "║ ${LIGHT_YELLOW}4. ${LIGHT_CYAN}python ld5.py ${LIGHT_CYAN}                                    ║"
echo -e "╚══════════════════════════════════════════════════════════╝${NC}"
echo ""
echo -e "${LIGHT_PURPLE}💡 Mẹo: ${WHITE}Bạn có thể chạy trực tiếp bằng cách nhập lệnh đầy đủ:"
echo -e "${LIGHT_YELLOW}   python /sdcard/Download/sn01.py"
echo ""
